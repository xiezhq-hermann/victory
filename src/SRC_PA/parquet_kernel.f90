...
contains
  ...
  subroutine reducible_vertex(ite)
    ...
    !acc data copy(dummy3D_1) copy(dummy3D_2) copy(dummy3D_3) copy(dummy3D_4) copy(G_d) copy(G_m) copy(G_s) copy(G_t)
    do k = 1, Nb
       idx = id*Nb + k
       ...
       istat = cublasXtZgemm(h, CUBLAS_OP_N, CUBLAS_OP_N, Nt, Nt, Nt, Half_c, G_d(1:Nt, 1:Nt, k), Nt, dummy3D_1(1:Nt, 1:Nt), Nt, Zero_c, dummy3D_3, Nt)
       istat = cublasXtZgemm(h, CUBLAS_OP_N, CUBLAS_OP_N, Nt, Nt, Nt, Half_c, G_m(1:Nt, 1:Nt, k), Nt, dummy3D_2(1:Nt, 1:Nt), Nt, Zero_c, dummy3D_4, Nt)
       ...
       istat = cublasXtZgemm(h, CUBLAS_OP_N, CUBLAS_OP_N, Nt, Nt, Nt, Half_c, dummy3D_1(1:Nt, 1:Nt), Nt, G_d(1:Nt, 1:Nt, k), Nt, One_c, dummy3D_3, Nt)
       istat = cublasXtZgemm(h, CUBLAS_OP_N, CUBLAS_OP_N, Nt, Nt, Nt, Half_c, dummy3D_2(1:Nt, 1:Nt), Nt, G_m(1:Nt, 1:Nt, k), Nt, One_c, dummy3D_4, Nt)
       ...
       istat = cublasXtZgemm(h, CUBLAS_OP_N, CUBLAS_OP_N, Nt, Nt, Nt, Half_c, G_s(1:Nt, 1:Nt, k), Nt, dummy3D_1(1:Nt, 1:Nt), Nt, Zero_c, dummy3D_3, Nt)
       istat = cublasXtZgemm(h, CUBLAS_OP_N, CUBLAS_OP_N, Nt, Nt, Nt, Half_c, G_t(1:Nt, 1:Nt, k), Nt, dummy3D_2(1:Nt, 1:Nt), Nt, Zero_c, dummy3D_4, Nt)
       ...
       istat = cublasXtZgemm(h, CUBLAS_OP_N, CUBLAS_OP_N, Nt, Nt, Nt, Half_c, dummy3D_1(1:Nt, 1:Nt), Nt, G_s(1:Nt, 1:Nt, k), Nt, One_c, dummy3D_3, Nt)
       istat = cublasXtZgemm(h, CUBLAS_OP_N, CUBLAS_OP_N, Nt, Nt, Nt, Half_c, dummy3D_2(1:Nt, 1:Nt), Nt, G_t(1:Nt, 1:Nt, k), Nt, One_c, dummy3D_4, Nt)
